            ...
            ""song (Song): The title of a song to add.
              position (Optional(int)): If specified, the song will be added to that position
                    in the track list - inserting it between other songs if necessary.
                     Otherwise, the song will be added tot he end of the list."""
...
class Artist:
    ...
    def add_song(self, name, year, title):
        ...
        This amethod will add the song to an album in the collection.
...
def find_object(field, object_list):
    """Check 'object_list' to see if an object with a 'name' atribute equal to 'field' exists, return it if so."""
...
def load_data():
    ...
    with open("albums.txt", "r") as albums:
        for line in albums:
            # data fow should consist of (artist, album, year, song)
