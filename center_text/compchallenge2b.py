...
print(nested_comp())
print(nested_gen())
result_1 = timeit.timeit(nested_loop, setups, number=10000)
result_2 = timeit.timeit(loop_comp, setups, number=10000)
result_3 = timeit.timeit(nested_comp, setups, number=10000)
result_4 = timeit.timeit(nested_gen, setups, number=10000)
